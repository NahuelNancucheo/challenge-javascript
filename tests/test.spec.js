...
describe('Practica del Checkpoint M1', function(){
    ...
    xdescribe('EJERCICIO 1: exponencial:', function() {
    ...
    xdescribe('EJERCICIO 2: direcciones:', function(){
        let lab1 = {
            N: 'pared', S: {
    ...
    xdescribe('EJERCICIO 3: deepEqualArrays', function(){
    ...
    xdescribe("EJERCICIO 4: OrderedLinkedList metodo add", function(){
    ...
    xdescribe("EJERCICIO 5: OrderedLinkedList metodo removeHigher", function(){
    ...
    xdescribe("EJERCICIO 6: OrderedLinkedList metodo removeLower", function(){
    ...
    xdescribe("EJERCICIO 7: multiCallbacks", function(){
        let arr = []
        const cbs1 = [
    ...
    xdescribe("EJERCICIO 9: primalityTest", function(){
    ...
    xdescribe("EJERCICIO 10: quickSort", function(){
    ...
    xdescribe("EJERCICIO 11: reverse", function(){
